...
{
    public class TextBoxScrollToEndBehaviour
    {
        ...
        public static readonly DependencyProperty ScrollOnTextChangedProperty =
            DependencyProperty.RegisterAttached("ScrollOnTextChanged", typeof(bool), typeof(TextBoxScrollToEndBehaviour), new UIPropertyMetadata(false, OnScrollOnTextChanged));
